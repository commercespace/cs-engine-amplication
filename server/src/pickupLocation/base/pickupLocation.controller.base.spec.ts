...
describe("PickupLocation", () => {
  ...
  test("POST /pickupLocations", async () => {
  ...
  test("GET /pickupLocations", async () => {
    await request(app.getHttpServer())
      .get("/pickupLocations")
  ...
  test("GET /pickupLocations/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pickupLocations"}/${nonExistingId}`)
  ...
  test("GET /pickupLocations/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pickupLocations"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
