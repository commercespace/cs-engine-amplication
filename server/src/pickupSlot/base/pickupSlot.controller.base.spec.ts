...
describe("PickupSlot", () => {
  ...
  test("GET /pickupSlots/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pickupSlots"}/${nonExistingId}`)
  ...
  test("GET /pickupSlots/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pickupSlots"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
