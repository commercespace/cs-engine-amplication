...
@ArgsType()
class UpdateServicePointArgs {
  @Field(() => ServicePointWhereUniqueInput, { nullable: false })
  where!: ServicePointWhereUniqueInput;
  @Field(() => ServicePointUpdateInput, { nullable: false })
  data!: ServicePointUpdateInput;
}

export { UpdateServicePointArgs };
